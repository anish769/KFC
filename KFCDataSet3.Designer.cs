...
namespace KFC {
    ...
    public partial class KFCDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/KFCDataSet3.xsd";
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomerRow AddCustomerRow(string CustomerName, string CustomerAddress, string ContactNumber, string Email) {
...
namespace KFC.KFCDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([CustomerName], [CustomerAddress], [ContactNumber], [Email]) VALUES (@CustomerName, @CustomerAddress, @ContactNumber, @Email);
SELECT CustomerID, CustomerName, CustomerAddress, ContactNumber, Email FROM Customer WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [CustomerName] = @CustomerName, [CustomerAddress] = @CustomerAddress, [ContactNumber] = @ContactNumber, [Email] = @Email WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_CustomerAddress = 1 AND [CustomerAddress] IS NULL) OR ([CustomerAddress] = @Original_CustomerAddress)) AND ((@IsNull_ContactNumber = 1 AND [ContactNumber] IS NULL) OR ([ContactNumber] = @Original_ContactNumber)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT CustomerID, CustomerName, CustomerAddress, ContactNumber, Email FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        public virtual int Fill(KFCDataSet.CustomerDataTable dataTable) {
        ...
        public virtual KFCDataSet.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KFCDataSet.CustomerDataTable dataTable = new KFCDataSet.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KFCDataSet.CustomerDataTable dataTable) {
        ...
        public virtual int Insert(string CustomerName, string CustomerAddress, string ContactNumber, string Email) {
        ...
        public virtual int Update(string CustomerName, string CustomerAddress, string ContactNumber, string Email, int Original_CustomerID, string Original_CustomerName, string Original_CustomerAddress, string Original_ContactNumber, string Original_Email, int CustomerID) {
            if ((CustomerName == null)) {
        ...
        public virtual int Update(string CustomerName, string CustomerAddress, string ContactNumber, string Email, int Original_CustomerID, string Original_CustomerName, string Original_CustomerAddress, string Original_ContactNumber, string Original_Email) {
            return this.Update(CustomerName, CustomerAddress, ContactNumber, Email, Original_CustomerID, Original_CustomerName, Original_CustomerAddress, Original_ContactNumber, Original_Email, Original_CustomerID);
        }
    }
